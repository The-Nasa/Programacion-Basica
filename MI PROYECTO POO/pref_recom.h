...
void limpiarBuffer1() { //funcion global.
    cin.clear(); // Limpiar el estado de error de cin--
    cin.ignore(numeric_limits<streamsize>::max(), '\n'); // Ignorar todos los caracteres hasta encontrar un salto de línea '\n'
    }

class Preferencias {
    friend class Calculo; //acceso directo a los valores obtenidos por preferencias.
...
public:
    unordered_map<string, int> realizarCalculos(const Preferencias& preferencias) {
        ...
        // Ajustar la cantidad de alimentos en función del tipo de alimentación
