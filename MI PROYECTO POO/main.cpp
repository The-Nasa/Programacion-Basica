...
void limpiarBuffer2() {
    ...
    cin.clear();
    // Descarta la línea de entrada incorrecta.
...
do
{
    // Limpiar la pantalla y mostrar menu
    limpiarPantalla();
    cout << colorCian;
    cout << "============================================================" << endl;
    cout << colorMagenta << "|                        MENU PRINCIPAL                    |" << resetColor << endl;
    cout << colorCian;
    cout << "============================================================" << endl;
    cout << resetColor << endl;
    cout << colorAmarillo << "|  [1]. MENU DE PRODUCTOS                                  |" << endl;
    ...
    // Convertir la entrada a un entero usando stringstream
    stringstream ss(entrada);
    if (!(ss >> opcion)) {
        cout << "Por favor, ingrese un valor numérico." << endl;
        system("pause");
        limpiarBuffer();
        continue; // Regresa al inicio del ciclo do-while
    }
    ...
    case 7:
        ...
        Calculo calculo;
        alimentosNecesarios = calculo.realizarCalculos(miAnimal); // Realizar los cálculos
